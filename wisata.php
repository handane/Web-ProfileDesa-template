         ...
         <div class="col-md-12 row g-3">
            <div class="col-md-6 mt-5 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <div class="card mt-2">
                     <img class="gambar-objek" src="image/wisata.jpg">
                  </div>
                  <div class="card card-body bg-light mt-2">
                     <h5 class="color-hijau-2">Arung Jeram</h5>
                     <p>Arung jeram menjadi satu diantara dua objek wisata yang ada di Kelurahan Mentawir</p>
                  </div>
               </div>
            </div>
            <div class="col-md-6 mt-5 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  ...
                  <div class="card card-body bg-light mt-2">
                     <h5 class="color-hijau-2">Mangrove</h5>
