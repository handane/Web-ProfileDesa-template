...
<body>
   ...
   <!-- artikel -->
   <div class="container-fluid">
      <h5 class="container artikel color-hijau-2 mb-4">Kontak</h5>
      <div class="container artikel">
         <figure>
            <img src="image/lembaga.jpg" alt="" style="width: 300px;">
         </figure>
         <h5>Kantor Kelurahan Mentawir</h5>
         <table>
            <tr>
               <th>Alamat</th>
               <td>:</td>
               <td>Jl. Mulawarman, RT 002</td>
            </tr>
            <tr>
               <th>Email</th>
               <td>:</td>
