...
<body>
   ...
   <div class="container-fluid">
      <div class="container artikel">
         <div class="color-hijau-2 bg-secondary bg-opacity-10 ps-4 p-2">
            <h5>Layanan Kesehatan</h5>
         </div>
         <div class="col-md-12 row g-3 m-auto">
            <div class="col-md-6 mt-5 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <h4 class="color-hijau-2">Poskesdes</h4>
                  <p>Pos Kesehatan Desa atau Poskesdes merupakan pusat layanan kesehatan yang ada di Kelurahan Mentawir</p>
                  <div class="card card-body bg-light">
                     <h6>Lokasi</h6>
                     <p>Jl. Mulawarman, RT 02, Kelurahan Mentawir</p>
                  </div>
                  <div class="card card-body mt-2 bg-light">
                     <img src="image/polindes.jpeg" style="height: 250px;">
                  </div>
               </div>
            </div>
            <div class="col-md-6 mt-5 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <h4 class="color-hijau-2">Ambulans</h4>
                  <p>Alat transportasi pelayanan kesehatan di Kelurahan Mentawir
                  </p>
                  <div class="card card-body bg-light">
                     <h6>Lokasi</h6>
                     <p>Jl. Mulawarman RT 02, Kelurahan Mentawir</p>
                  ...
                  <div class="card card-body container mt-2 bg-light">
                     <img src="image/ambulans.jpg" style="height: 250px;">
                  </div>
               </div>
            </div>
         </div>
