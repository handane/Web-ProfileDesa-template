...
<body>
   ...
   <!-- artikel -->
   <div class="container-fluid">
      <div class="container artikel color-hijau-2 bg-secondary bg-opacity-10 ps-4 p-2 g-3 mb-4">
         <h5>Produk Desa</h5>
      </div>
   </div>
   <div class="container-fluid">
      <div class="container artikel">
         <div class="col-md-12 row g-3">
            <div class="col-md-4 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <div class="card mt-2">
                     <img class="gambar-objek" src="image/produk-desa.jpg">
                  </div>
                  <div class="card card-body bg-light mt-2">
                     <h5 class="color-hijau-2">Sirup Mangrove</h5>
            ...
            <div class="col-md-4 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <div class="card mt-2">
                     <img class="gambar-objek" src="image/anyaman1.jpg">
                  </div>
                  <div class="card card-body bg-light mt-2">
                     <h5 class="color-hijau-2">Kotak Tisue dari bambu</h5>
            ...
            <div class="col-md-4 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <div class="card mt-2">
                     <img class="gambar-objek" src="image/bedak-dingin.jpeg">
                  </div>
                  <div class="card card-body bg-light mt-2">
                     <h5 class="color-hijau-2">Pupur Dingin Mangrove</h5>
                  </div>
               </div>
            </div>
            <div class="col-md-4 color-hitam text-justify">
               <div class="card card-body col-md-12 shadow-lg border-0 pe-4 ps-4">
                  <div class="card mt-2">
                     <img class="gambar-objek" src="image/telenan.jpg">
                  </div>
                  <div class="card card-body bg-light mt-2">
                     <h5 class="color-hijau-2">Nampan dari bambu</h5>
                  </div>
               </div>
            </div>
         </div>
