...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3904530952ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="249">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=galeri">`mentawir`.`galeri`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=tingkat_pendidikan">`mentawir`.`tingkat_pendidikan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=agama">`mentawir`.`agama`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=rt">`mentawir`.`rt`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=lembaga_pemerintahan">`mentawir`.`lembaga_pemerintahan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=demografi">`mentawir`.`demografi`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=silsilah_kepala_kelurahan">`mentawir`.`silsilah_kepala_kelurahan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=mentawir&table=rtrw">`mentawir`.`rtrw`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=contoh">`sidini`.`contoh`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=sidini&table=tenaga_pendidik">`sidini`.`tenaga_pendidik`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="597a2f3a2351292348345f365a3e5f26">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="249"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="mentawir" targettable="tingkat_pendidikan">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tingkat_pendidikan`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mentawir" targettable="galeri">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `galeri`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="mentawir" targettable="galeri">
                            <div class="action_content">
